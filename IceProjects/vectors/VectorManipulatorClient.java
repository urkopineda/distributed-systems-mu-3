public class VectorManipulatorClient
{
  ...
  public static void main(String args[])
  {
	  ...
	  try 
	  {
	    ...
	    if (theManipulator == null) throw new Error("Invalid proxy");
	    System.out.print("Let us consider the next vector \n\t") ;
	    for(i=0;i<aVector.length;i++) System.out.print(aVector[i]+" ");
	    System.out.println();
	    System.out.print("\nAfter sorting it remains:\n\t") ;
	    theManipulator.sort(aVector, vectorHolder);
        for(i=0;i<vectorHolder.value.length;i++) System.out.print(vectorHolder.value[i]+" ");
        System.out.println();
